...
$.ajax({
    ...
    data: {
        key: 'VELBZ-2YECG-2ZBQW-QEBWJ-JZRXF-C7FRZ',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(120.40556730688473, 36.12445152006917, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
